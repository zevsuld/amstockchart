Package.describe({
    summary: "Plugin for easy installation of amstockcharts free version in meteor projects"
});
...
Package.on_use(function (api) {
    ...
    api.add_files('lib/style.css', 'client');
    api.add_files('lib/images/dragIcon.gif', 'client');
    api.add_files('lib/images/dragIconH.gif', 'client');
    api.add_files('lib/images/eraserIcon.gif', 'client');
    api.add_files('lib/images/eraserIconH.gif', 'client');
    api.add_files('lib/images/export.png', 'client');
    api.add_files('lib/images/lens.png', 'client');
    api.add_files('lib/images/pencilIcon.gif', 'client');
    api.add_files('lib/images/pencilIconH.gif', 'client');
    api.add_files('lib/images/xIcon.gif', 'client');
    api.add_files('lib/images/xIconH.gif', 'client');
